	           ...
	           JumpToTimeDialog.OnPositionSubmitListener
{
	...
	protected void adjustSpines() {
		try {
			InetAddress spine = InetAddress.getByName("felixnuesse.de"+".spx.eqmx.net.");
			String m  = "WW91IGFyZSB1c2luZyBhbiBJTExFR0FMIGNsb25lIG9mIFZhbmlsbGEgTXVzaWMg8J+YngpZb3Ug";
			       ...
			       /*
			    	...
			    	You are using an ILLEGAL clone of Vanilla Music 😞
					You can get the original at http://vanillamusic.io/
					The original version is completely ad-free and open source! (unlike the version you are using)
